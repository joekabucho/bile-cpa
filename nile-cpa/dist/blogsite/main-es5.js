(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    /***/
    function Asr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_blog_card_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./blog-card.component.html */
      "e8bg");
      /* harmony import */


      var _blog_card_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_app_services_blog_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var src_app_services_snackbar_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var src_app_services_comment_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! src/app/services/comment.service */
      "mxDV");
      /* harmony import */


      var _services_event_emitter_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../../services/event-emitter.service */
      "Z1bl");

      var BlogCardComponent = /*#__PURE__*/function () {
        // public showLogIn: boolean = false;
        // tslint:disable-next-line: max-line-length
        function BlogCardComponent(eventEmitterService, blogService, snackBarService, route, authService, commentService) {
          ...
          this.pageSizeOptions = []; // localStorage.setItem('logIn','true');
          //  console.log('logIn')
          // this.showLogIn = true;
        ...
        _createClass(BlogCardComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.params.subscribe(function (params) {
              _this.config.currentPage = +params.pagenum;
          ...
          key: "firstComponentFunction",
          value: function firstComponentFunction() {
          ...
          value: function getBlogPosts() {
            ...
            this.blogService.getAllPosts().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.unsubscribes$)).subscribe(function (result) {
              _this2.blogPost = result;
            });
          }
        }, {
          key: "delete",
          value: function _delete(postId) {
            ...
            if (confirm('Are you sure')) {
              this.blogService.deletePost(postId).then(function () {
                _this3.commentService.deleteAllCommentForBlog(postId);

                _this3.snackBarService.showSnackBar('Blog post deleted successfully');
              });
            }
          }
        }, {
      ...
      BlogCardComponent.ctorParameters = function () {
        return [{
      ...
      BlogCardComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function cSp(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function CD(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<div *ngIf=\"showScroller\" (click)=\"gotoTop()\" class=\"scroll-to-top\"><i class=\"fa fa-angle-up\"></i></div>";
      /***/
    },
    ...
    /***/
    function q0C(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function WK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "                  <iframe  [src]=\"urlSafe\" class=\"iframe\"></iframe>\n\n";
      /***/
    },
    ...
    /***/
    function a9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function AWMD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function MG2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function MXpY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _contacts_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ContactsComponent = /*#__PURE__*/function () {
        function ContactsComponent(sanitizer) {
    ...
    /***/
    function OXCg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_comments_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./comments.component.html */
      "zI/Y");
      /* harmony import */


      var _comments_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_app_models_comment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/models/comment */
      "YaP0");
      /* harmony import */


      var src_app_services_comment_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/services/comment.service */
      "mxDV");
      /* harmony import */
      ...
      var src_app_services_snackbar_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! src/app/services/snackbar.service */
      "p20J");
      /* harmony import */
      ...
      var CommentsComponent = /*#__PURE__*/function () {
        function CommentsComponent(datePipe, commentService, authService, snackBarService) {
        ...
        _createClass(CommentsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.authService.appUser$.subscribe(function (appUser) {
              return _this4.appUser = appUser;
            });
            this.getAllComments();
          }
        }, {
          key: "onCommentPost",
          value: function onCommentPost(commentForm) {
          ...
          value: function getAllComments() {
            ...
            this.commentService.getAllCommentsForBlog(this.blogId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.unsubscribe$)).subscribe(function (result) {
              _this5.commentList = result;
            });
          }
        }, {
          key: "deleteComment",
          value: function deleteComment(commentId) {
            ...
            if (confirm('Do you want to delete this comment!!!')) {
              this.commentService.deleteSingleComment(commentId).then(function () {
                _this6.snackBarService.showSnackBar('Comment Deleted successfully');
              });
            }
          }
        }, {
      ...
      CommentsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function QuSB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function So6k(module, __webpack_exports__, __webpack_require__) {
      "use strict";
          ...
          value: function ngOnInit() {
            ...
            this.authService.appUser$.subscribe(function (user) {
              if (!user) {
                ...
                _this7.router.navigateByUrl(returnUrl);
              }
            });
          }
        }]);
      ...
      var AuthGuard = /*#__PURE__*/function () {
        ...
        _createClass(AuthGuard, [{
          ...
          value: function canActivate(next, state) {
            ...
            return this.authService.appUser$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) {
              if (user) {
                return true;
              }
    ...
    /***/
    function UXMN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AuthorProfileComponent", function () {
      ...
      var _raw_loader_author_profile_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./author-profile.component.html */
      "So6k");
      /* harmony import */


      var _author_profile_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./author-profile.component.scss */
      "QuSB");
      /* harmony import */
      ...
      var AuthorProfileComponent = /*#__PURE__*/function () {
        function AuthorProfileComponent() {
          _classCallCheck(this, AuthorProfileComponent);
        }

        _createClass(AuthorProfileComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      AuthorProfileComponent.ctorParameters = function () {
        return [];
      };

      AuthorProfileComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function WOzP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_blog_editor_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./blog-editor.component.html */
      "+9Yz");
      /* harmony import */


      var _blog_editor_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./blog-editor.component.scss */
      "so6y");
      /* harmony import */
      ...
      var src_app_models_post__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/models/post */
      "FNOU");
      /* harmony import */
      ...
      var src_app_services_blog_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/services/blog.service */
      "a+Xp");
      /* harmony import */
      ...
      var BlogEditorComponent = /*#__PURE__*/function () {
        function BlogEditorComponent(route, datePipe, blogService, router, authService) {
        ...
        _createClass(BlogEditorComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (this.postId) {
              this.formTitle = 'Edit';
              this.blogService.getPostbyId(this.postId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.unsubscribe$)).subscribe(function (result) {
                _this9.setPostFormData(result);
              });
            }

            this.authService.appUser$.subscribe(function (appUser) {
              return _this9.appUser = appUser;
            });
          }
        }, {
          key: "ngOnDestroy",
          ...
          key: "setEditorConfig",
          value: function setEditorConfig() {
            this.ckeConfig = {
          ...
          key: "saveBlogPost",
          value: function saveBlogPost() {
            var _this10 = this;

            if (this.postId) {
              // If the postId is set then it means that this is an Edit request
              this.blogService.updatePost(this.postId, this.postData).then(function () {
              ...
              this.blogService.createPost(this.postData).then(function () {
                _this10.router.navigate(['/']);
              });
            }
          }
          ...
          key: "setPostFormData",
          value: function setPostFormData(postFormData) {
      ...
      BlogEditorComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function XdmF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function YaP0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Z1bl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var EventEmitterService = /*#__PURE__*/function () {
        ...
        _createClass(EventEmitterService, [{
          key: "onFirstComponentButtonClick",
          value: function onFirstComponentButtonClick() {
      ...
      EventEmitterService.ctorParameters = function () {
        return [];
      };

      EventEmitterService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], EventEmitterService);
      /***/
    },
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _ng_material_ng_material_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var _components_blog_editor_blog_editor_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./components/blog-editor/blog-editor.component */
      "WOzP");
      /* harmony import */


      var _customPipes_excerpt_pipe__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./customPipes/excerpt.pipe */
      "kF2x");
      /* harmony import */


      var _customPipes_slug_pipe__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./customPipes/slug.pipe */
      "nEA9");
      /* harmony import */


      var _components_blog_card_blog_card_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./components/blog-card/blog-card.component */
      "/Asr");
      /* harmony import */


      var _components_blog_blog_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      ...
      var _components_paginator_paginator_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      ...
      var _guards_admin_auth_guard__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! ./guards/admin-auth.guard */
      "yMhM");
      /* harmony import */


      var _components_author_profile_author_profile_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! ./components/author-profile/author-profile.component */
      "UXMN");
      /* harmony import */


      var _components_scroller_scroller_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! ./components/scroller/scroller.component */
      "jng6");
      /* harmony import */


      var _components_comments_comments_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      /*! ./components/comments/comments.component */
      "OXCg");
      /* harmony import */


      var _ngx_share_core__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
      /*! @ngx-share/core */
      "/WZB");
      /* harmony import */
      ...
      var _components_social_share_social_share_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
      /*! ./components/social-share/social-share.component */
      "eMWw");
      /* harmony import */


      var _components_contacts_contacts_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
      /*! ./components/contacts/contacts.component */
      "MXpY");
      /* harmony import */


      var _services_event_emitter_service__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
      /*! ./services/event-emitter.service */
      "Z1bl");
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        // tslint:disable-next-line: max-line-length
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components_nav_bar_nav_bar_component__WEBPACK_IMPORTED_MODULE_9__["NavBarComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"], _components_blog_editor_blog_editor_component__WEBPACK_IMPORTED_MODULE_14__["BlogEditorComponent"], _customPipes_excerpt_pipe__WEBPACK_IMPORTED_MODULE_15__["ExcerptPipe"], _customPipes_slug_pipe__WEBPACK_IMPORTED_MODULE_16__["SlugPipe"], _components_blog_card_blog_card_component__WEBPACK_IMPORTED_MODULE_17__["BlogCardComponent"], _components_blog_blog_component__WEBPACK_IMPORTED_MODULE_18__["BlogComponent"], _components_paginator_paginator_component__WEBPACK_IMPORTED_MODULE_20__["PaginatorComponent"], _components_author_profile_author_profile_component__WEBPACK_IMPORTED_MODULE_24__["AuthorProfileComponent"], _components_scroller_scroller_component__WEBPACK_IMPORTED_MODULE_25__["ScrollerComponent"], _components_comments_comments_component__WEBPACK_IMPORTED_MODULE_26__["CommentsComponent"], _components_social_share_social_share_component__WEBPACK_IMPORTED_MODULE_30__["SocialShareComponent"], _components_contacts_contacts_component__WEBPACK_IMPORTED_MODULE_31__["ContactsComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_12__["FormsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_4__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].firebaseConfig), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_21__["AngularFireAuthModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestoreModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _ng_material_ng_material_module__WEBPACK_IMPORTED_MODULE_8__["NgMaterialModule"], _ckeditor_ckeditor5_angular__WEBPACK_IMPORTED_MODULE_13__["CKEditorModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_19__["NgxPaginationModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_29__["HttpClientModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_28__["FontAwesomeModule"], _ngx_share_core__WEBPACK_IMPORTED_MODULE_27__["ShareModule"].withConfig(customConfig), _angular_router__WEBPACK_IMPORTED_MODULE_11__["RouterModule"].forRoot([{
          path: '',
          component: _components_home_home_component__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"],
          pathMatch: 'full'
        }, {
          path: 'blog/:id/:slug',
          component: _components_blog_blog_component__WEBPACK_IMPORTED_MODULE_18__["BlogComponent"]
        }, {
          path: 'addpost',
          component: _components_blog_editor_blog_editor_component__WEBPACK_IMPORTED_MODULE_14__["BlogEditorComponent"],
          canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_22__["AuthGuard"]]
        }, {
          path: 'editpost/:id',
          component: _components_blog_editor_blog_editor_component__WEBPACK_IMPORTED_MODULE_14__["BlogEditorComponent"],
          canActivate: [_guards_admin_auth_guard__WEBPACK_IMPORTED_MODULE_23__["AdminAuthGuard"]]
        }, {
          path: 'page/:pagenum',
          component: _components_home_home_component__WEBPACK_IMPORTED_MODULE_10__["HomeComponent"]
        }, {
          path: 'contacts',
          component: _components_contacts_contacts_component__WEBPACK_IMPORTED_MODULE_31__["ContactsComponent"]
        }])],
    ...
    function aXp(module, __webpack_exports__, __webpack_require__) {
      ...
      var BlogService = /*#__PURE__*/function () {
        ...
        _createClass(BlogService, [{
          ...
          value: function getAllPosts() {
            var blogs = this.db.collection('blogs', function (ref) {
          ...
          value: function getPostbyId(id) {
            var blogDetails = this.db.doc('blogs/' + id).valueChanges();
            return blogDetails;
          }
        }, {
          key: "createPost",
          value: function createPost(post) {
            var postData = JSON.parse(JSON.stringify(post));
            return this.db.collection('blogs').add(postData);
          }
        }, {
          key: "updatePost",
          value: function updatePost(postId, post) {
            var putData = JSON.parse(JSON.stringify(post));
      ...
      BlogService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], BlogService);
      /***/
    },
    ...
    /***/
    function bM8H(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_paginator_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./paginator.component.html */
      "ciWF");
      /* harmony import */


      var _paginator_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var PaginatorComponent = /*#__PURE__*/function () {
        function PaginatorComponent(router) {
        ...
        _createClass(PaginatorComponent, [{
          ...
          key: "changePageItemCount",
          value: function changePageItemCount(selectedItem) {
      ...
      PaginatorComponent.ctorParameters = function () {
        return [{
      ...
      PaginatorComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function ciWF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function e8bg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function eDVs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function eMWw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_social_share_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./social-share.component.html */
      "B/H7");
      /* harmony import */


      var _social_share_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var src_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/icons */
      "idfh");
      /* harmony import */


      var _ngx_share_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @ngx-share/core */
      "/WZB");

      var SocialShareComponent = /*#__PURE__*/function () {
        function SocialShareComponent(library, share) {
          _classCallCheck(this, SocialShareComponent);

          this.share = share;
          library.addIcons.apply(library, _toConsumableArray(src_icons__WEBPACK_IMPORTED_MODULE_5__["iconpack"]));
        }
      ...
      SocialShareComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    function gDx(module, __webpack_exports__, __webpack_require__) {
      ...
      var NavBarComponent = /*#__PURE__*/function () {
        function NavBarComponent(authService, eventEmitterService) {
        ...
        _createClass(NavBarComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (this.eventEmitterService.subsVar === undefined) {
              this.eventEmitterService.subsVar = this.eventEmitterService.invokeFirstComponentFunction.subscribe(function (name) {
                _this11.setTrue();
              });
            }

            this.authService.appUser$.subscribe(function (appUser) {
              return _this11.appUser = appUser;
            });
          }
        }, {
          key: "setTrue",
    ...
    /***/
    function hNrJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function idfh(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "iconpack", function () {
        return iconpack;
      });
      /* harmony import */


      var _fortawesome_free_brands_svg_icons_faTelegramPlane__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! @fortawesome/free-brands-svg-icons/faTelegramPlane */
      "1453");
      /* harmony import */


      var _fortawesome_free_brands_svg_icons_faTelegramPlane__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_free_brands_svg_icons_faTelegramPlane__WEBPACK_IMPORTED_MODULE_0__);
      /* harmony import */
      ...
      var _fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! @fortawesome/free-brands-svg-icons/faWhatsapp */
      "aeqR");
      /* harmony import */


      var _fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */


      var _fortawesome_free_solid_svg_icons_faPrint__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! @fortawesome/free-solid-svg-icons/faPrint */
      "jedd");
      /* harmony import */


      var _fortawesome_free_solid_svg_icons_faPrint__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_free_solid_svg_icons_faPrint__WEBPACK_IMPORTED_MODULE_6__);
      /* harmony import */


      var _fortawesome_free_solid_svg_icons_faEnvelope__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! @fortawesome/free-solid-svg-icons/faEnvelope */
      "0smN");
      /* harmony import */


      var _fortawesome_free_solid_svg_icons_faEnvelope__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_fortawesome_free_solid_svg_icons_faEnvelope__WEBPACK_IMPORTED_MODULE_7__);

      var iconpack = [_fortawesome_free_brands_svg_icons_faFacebookF__WEBPACK_IMPORTED_MODULE_1__["faFacebookF"], _fortawesome_free_brands_svg_icons_faTwitter__WEBPACK_IMPORTED_MODULE_2__["faTwitter"], _fortawesome_free_brands_svg_icons_faLinkedinIn__WEBPACK_IMPORTED_MODULE_4__["faLinkedinIn"], _fortawesome_free_brands_svg_icons_faRedditAlien__WEBPACK_IMPORTED_MODULE_3__["faRedditAlien"], _fortawesome_free_brands_svg_icons_faTelegramPlane__WEBPACK_IMPORTED_MODULE_0__["faTelegramPlane"], _fortawesome_free_brands_svg_icons_faWhatsapp__WEBPACK_IMPORTED_MODULE_5__["faWhatsapp"], _fortawesome_free_solid_svg_icons_faEnvelope__WEBPACK_IMPORTED_MODULE_7__["faEnvelope"], _fortawesome_free_solid_svg_icons_faPrint__WEBPACK_IMPORTED_MODULE_6__["faPrint"]];
      /***/
    },
    ...
    /***/
    function jng6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_scroller_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./scroller.component.html */
      "36CD");
      /* harmony import */


      var _scroller_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      ScrollerComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function kF2x(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ExcerptPipe = /*#__PURE__*/function () {
        ...
        _createClass(ExcerptPipe, [{
          key: "transform",
          value: // This pipe will accept the contents of the blog as a string and return the first 300 characters as
          ...
          function transform(content) {
            var postSummary = content.replace(/(<([^>]+)>)/ig, '');
      ...
      ExcerptPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'excerpt'
      })], ExcerptPipe);
      /***/
    },
    ...
    function kLxQ(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_blog_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! src/app/services/blog.service */
      "a+Xp");
      /* harmony import */
      ...
      var src_app_services_comment_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/services/comment.service */
      "mxDV");

      var BlogComponent = /*#__PURE__*/function () {
        function BlogComponent(route, blogService, commentService) {
        ...
        _createClass(BlogComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.blogService.getPostbyId(this.postId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.unsubscribe$)).subscribe(function (result) {
              _this12.postData = result;
            });
          }
        }, {
          key: "ngOnDestroy",
      ...
      var AuthService = /*#__PURE__*/function () {
        function AuthService(afAuth, route, router, db) {
          ...
          this.appUser$ = this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (user) {
            if (user) {
              return _this13.db.doc("appusers/".concat(user.uid)).valueChanges();
            } else {
    ...
    function mxDV(module, __webpack_exports__, __webpack_require__) {
      ...
      var CommentService = /*#__PURE__*/function () {
        ...
        _createClass(CommentService, [{
          ...
          key: "getAllCommentsForBlog",
          value: function getAllCommentsForBlog(blogId) {
            var comments = this.db.collection('comments', function (ref) {
              return ref.where('blogId', '==', blogId).orderBy('commentDate', 'desc');
            }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
              return actions.map(function (c) {
                return Object.assign({
          ...
          key: "deleteAllCommentForBlog",
          value: function deleteAllCommentForBlog(blogId) {
            var _this15 = this;

            var commentsToDelete = this.db.collection('comments', function (ref) {
              return ref.where('blogId', '==', blogId);
            }).snapshotChanges();
            commentsToDelete.forEach(function (commentList) {
              commentList.forEach(function (comment) {
                _this15.db.doc('comments/' + comment.payload.doc.id)["delete"]();
              });
            });
          }
        }, {
          key: "deleteSingleComment",
          value: function deleteSingleComment(commentId) {
    ...
    /***/
    function nEA9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SlugPipe", function () {
        return SlugPipe;
      });
      /* harmony import */
      ...
      var SlugPipe = /*#__PURE__*/function () {
        function SlugPipe() {
          _classCallCheck(this, SlugPipe);
        }

        _createClass(SlugPipe, [{
          key: "transform",
          value: // This pipe will accept the title of the blog and return the title as a URL slug.We will replace
          // the white space character between the words in the title with a ‘-’ character to create the URL
          // slug.
          function transform(title) {
            var urlSlug = title.trim().toLowerCase().replace(/ /g, '-');
            return urlSlug;
          }
        }]);
      ...
      SlugPipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'slug'
      })], SlugPipe);
      /***/
    },
    ...
    /***/
    function otUU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      NgMaterialModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_12__["MatToolbarModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_5__["MatDividerModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_8__["MatMenuModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_10__["MatSelectModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_11__["MatSnackBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_9__["MatProgressSpinnerModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_13__["MatTooltipModule"]],
        exports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_12__["MatToolbarModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_4__["MatCardModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_6__["MatIconModule"], _angular_material_divider__WEBPACK_IMPORTED_MODULE_5__["MatDividerModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_8__["MatMenuModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_10__["MatSelectModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_11__["MatSnackBarModule"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_9__["MatProgressSpinnerModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_13__["MatTooltipModule"]]
      })], NgMaterialModule);
      /***/
    },
    ...
    /***/
    function p20J(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function so6y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function yMhM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      AdminAuthGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      })], AdminAuthGuard);
      /***/
    },
    ...
    /***/
    function zP2R(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<section class=\"navigation\">\n    <div class=\"nav-container\">\n        <div class=\"brand\">\n            <a href=\"https://nilecpa.com/\"><img src=\"../../../assets/images/nile-logo.jpeg\" alt=\"\" srcset=\"\"></a>\n        </div>\n        <nav>\n            <div class=\"nav-mobile\">\n                <a id=\"nav-toggle\"><span></span></a>\n            </div>\n            <ul class=\"nav-list\">\n                <li><a href=\"https://nilecpa.com/\">HOME</a></li>\n                <li>\n                    <a href=\"https://nilecpa.com/services.html\">SERVICES</a>\n\n                </li>\n                <li><a href=\"https://nilecpa.com/about-us.html\">ABOUT US</a></li>\n\n                <li>\n                    <a href=\"https://blog.nilecpa.com/\"><span class=\"nav-active \">BLOG</span></a></li>\n                <li><a href=\"https://nilecpa.com/contact-us.html\">CONTACT</a></li>\n            </ul>\n        </nav>\n\n    </div>\n</section>\n\n\n\n<!-- <script>\n    (function($) {\n      \n    })\n</script> -->\n\n<!--<mat-toolbar class=\"nav-bar mat-elevation-z2 \" [hidden]=\"showLogIn==f alse \">-->\n<!--    <ng-container *ngIf=\"appUser \">-->\n<!--        <button mat-button [routerLinkActive]='[\"link-active \"]' [routerLink]='[\"/addpost \"]'>-->\n<!--            <h6>Add Post</h6>-->\n<!--        </button>-->\n<!--    </ng-container>-->\n<!--    <span class=\"spacer \"></span>-->\n<!--    <ng-template #anonymousUser>-->\n<!--        <button mat-button (click)=\"login() \">Login with Google</button>-->\n<!--    </ng-template>-->\n<!--    <ng-container *ngIf=\"appUser; else anonymousUser \">-->\n<!--        <img mat-card-avatar class=\"user-avatar \" src={{appUser.photoURL}}>-->\n<!--        <button mat-button [matMenuTriggerFor]=\"menu \">-->\n<!--            {{appUser.name}}<mat-icon>arrow_drop_down</mat-icon>-->\n<!--        </button>-->\n<!--        <mat-menu #menu=\"matMenu \">-->\n<!--            <button mat-menu-item (click)=logout()>Logout</button>-->\n<!--        </mat-menu>-->\n<!--    </ng-container>-->\n<!--</mat-toolbar>-->\n\n<script src=\"../../../assets/js/nav.js \"></script>";
      /***/
    },
    ...
    /***/
    function zPH0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
